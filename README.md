...
> **Note:** You are on the `K1tests` branch — Sub-Center ArcFace with **K=1** sub-centers (standard ArcFace). See the other branches (`K3tests`, `K5tests`) for different K ablations.
...
| Loss head | Sub-Center ArcFace (K=1 sub-center, s=64, m=0.5) |
