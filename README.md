...
> **Note:** You are on the `K5tests` branch — Sub-Center ArcFace with **K=5** sub-centers. See the other branches (`K1tests`, `K3tests`) for different K ablations.
...
| Loss head | Sub-Center ArcFace (K=5 sub-centers, s=64, m=0.5) |
